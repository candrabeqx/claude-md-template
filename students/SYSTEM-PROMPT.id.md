...
Tempel ke pengaturan AI-mu (ChatGPT: Settings → Personalization → Custom instructions · Gemini: Settings & help → Personal Intelligence → Instructions for Gemini · Claude: Settings → Account → Instructions for Claude, atau instruksi sebuah Project), atau sebagai pesan pertama di chat. Lalu ubah minimal dua aturan supaya cocok dengan hidupmu.
