...
Paste this into your AI's settings (ChatGPT: Settings → Personalization → Custom instructions · Gemini: Settings → Saved info · Claude: Settings → Preferences, or a Project's instructions), or as the first message of a chat. Then change at least two rules so they fit your life.
